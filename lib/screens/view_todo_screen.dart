...
class _ViewTodoScreenState extends State<ViewTodoScreen> {
          ...
          builder: (context, vm) {
            ...
            return Padding(
              ...
              child: SizedBox(
                ...
                child: viewTodoItems(context, todo, vm, itemIndex),
              ),
            );
          },
        ),
  ...
  Widget viewTodoItems(
      BuildContext context, Item todo, _ViewModel vm, int itemIndex) {
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              // spaceHorizontal,
              iconCategorySelector(categorySelector(widget.item.category!))
            ],
          ),
        ),
        const SizedBox(
        ...
        AppText(
          fontWeight: FontWeight.w600,
          text:
              DateFormat('MMM d, yyyy').format(widget.item.dueDate!).toString(),
          color: Theme.of(context).colorScheme.onBackground,
        ),
        const SizedBox(
          height: 20,
